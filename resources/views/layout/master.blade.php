            ...
            <div class="col-lg-4 text-center bg-secondary py-3">
                <div class="d-inline-flex align-items-center justify-content-center">
                    ...
                    <div class="text-start">
                        ...
                        <span class="pe-2">cakeshop1960@gmail.com</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 text-center bg-primary border-inner pt-3">
                <div class="d-inline-flex align-items-center justify-content-center">
                    <a href="{{ route('home.index')}}" class="navbar-brand">
                        <h1 class="m-0 text-uppercase text-white mb-3"><i class="fa fa-mug-hot text-white"></i> Cake Shop</h1>
                    </a>
                </div>
            </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">cakeshop1960@gmail.com</p>
                            </div>
                            <div class="d-flex mb-2">
