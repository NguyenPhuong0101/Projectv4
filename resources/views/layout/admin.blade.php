...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?php if($page == 'productadd'){echo 'active';}?>" href="{{ route('product_add') }}">Add Product</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item <?php if($page == 'protypeadd'){echo 'active';}?>" href="{{ route('protype_add') }}">Add Protype</a>
                    </div>
                </div>
            </li>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <h5>Admin for Delicious Bakery</h5>
                        </div>
                    </form>
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('/admin12/vendor/chart.js/Chart.min.js') }}"></script>
